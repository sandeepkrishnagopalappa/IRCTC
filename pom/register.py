...
class Register:
    ...
    def station_from_sending_keys(self):
        ...
        Register.ObjectGen.send_keys(self.driver, reg4, values="Chennai")
    ...
    def station_from_click(self):
        ...
        Register.ObjectGen.click(self.driver, reg5)
    ...
    def station_to_sending_keys(self):
        ...
        Register.ObjectGen.send_keys(self.driver, reg6, values="Mumbai")
    ...
    def station_to_click(self):
        ...
        Register.ObjectGen.click(self.driver, reg7)
    ...
    def start_date_select(self):
        ...
        Register.ObjectGen.click(self.driver, reg8)
    ...
    def return_date_click(self):
        ...
        Register.ObjectGen.click(self.driver, reg9)
    ...
    def apirl_month_select(self):
        ...
        Register.ObjectGen.click(self.driver, reg10)
    ...
    def gst_pop_up(self):
        reg15 = Register.variable1["gst_pop_up"]
        Register.ObjectGen.click(self.driver, reg15)
